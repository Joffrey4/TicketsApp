...
function generateArray() {
    ...
    fs.writeFile(path.join(__dirname, "generated/stationsData.json.js"), JSON.stringify(stationsJSON), function(err) {
        if(err) {
            ...
            console.log("SUCCESS - stationData.json.js generated")
        }
    });
    ...
    fs.writeFile(path.join(__dirname, "generated/stationsList.json.js"), JSON.stringify(stationsListJSON), function(err) {
        if(err) {
            ...
            console.log("SUCCESS - stationsList.json.js generated")
        }
    });
    ...
    fs.writeFile(path.join(__dirname, "generated/internalNames.json"), JSON.stringify(internalNames), function(err) {
        if(err) {
            ...
            console.log("SUCCESS - internalNames.json generated")
        }
    });
}
...
function createInternalName(station) {
    ...
    // Codify the name
    name = removeDiacritics(name); // Remove accent and diacritics
